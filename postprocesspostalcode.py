...
'''
uniqueFSA = pd.read_excel(open('static/data/yuride_postalcodes_filtered-maseter.xlsx', 'rb'),
                                sheetname='UniqueFSA') #replace with Unique PC and update uniqueFSA.values in loop

gtaplaceNames = ['Ajax','Aurora','Brampton','Brock','Burlington','Caledon','Clarington','East Gwillimbury','Georgina','Halton Hills','King','Markham','Milton','Mississauga','Newmarket','Oakville','Oshawa','Pickering','Richmond Hill','Scugog','Toronto','Uxbridge','Vaughan','Whitby','Whitby','Whitchurch-Stouffville']

uniqueFSAList = {}
for count, fsa, place in uniqueFSA.values:
...
uniqueFSAList.to_excel(writer, sheet_name='Unique GTA FSA')
