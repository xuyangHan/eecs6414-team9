...
api_url = 'https://maps.googleapis.com/maps/api/place/textsearch/json?query=fitness%20around%20york%20university&key=AIzaSyDx5AdpkLfmEeXncr9rjw3j9h6TKpcRGbY'
...
df['name'] = name
df['rating'] = rating
writer = pd.ExcelWriter('static/data/fitness.xlsx', engine='xlsxwriter')
